    ...
    while ($ReturnAulasAluno = mysql_fetch_assoc($ExeQueryAulasAssistidas)) {
        ...
        while ($DadosAulas = mysql_fetch_assoc($ExeQrBuscarAulas)) {
            ...
            <article class="col-md-12">
                <img src="<?php echo $DadosAulas['img_capa'] ?>" title="" alt="" class="img-responsive img-rounded img-bordered col-xs-12 col-sm-8 col-md-6 col-lg-6">
                <p class="lead hidden-xs col-sm-4 col-md-6 col-lg-6" style="padding-top:12.5%;"><a href="<?php echo $DadosAulas['link_apresentacao']; ?>" target="new">Aula <?php echo $DadosAulas['numero_aula'] ?> - <?php echo $DadosAulas['titulo_aula'] ?></a></p>
            </article>
